...
public class TinyDB {
    ...
    public ArrayList<ProductOrder> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductOrder> plist =  new ArrayList<ProductOrder>();

        for(String jObjString : objStrings){
            ProductOrder item  = gson.fromJson(jObjString,  ProductOrder.class);
            plist.add(item);
        }
        return plist;
    }
    ...
    public void putListObject(String key, ArrayList<ProductOrder> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProductOrder player: playerList){
            objStrings.add(gson.toJson(player));
        }
        System.out.println(objStrings);
