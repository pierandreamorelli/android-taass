...
public class CartListActivity extends AppCompatActivity {
    ...
    public void checkout(View view) throws IOException {

        GoogleSignInAccount lastSignedInAccount= GoogleSignIn.getLastSignedInAccount(this);
        if(lastSignedInAccount!=null) {
            managementCart.payment();
            Toast.makeText(this, "Congrats! Order fullfilled Successfully.", Toast.LENGTH_SHORT).show();
        }else{
            Toast toast = Toast.makeText(this, "You must be logged to complete the payment!", Toast.LENGTH_SHORT);
            toast.show();
        }
